...
## [12.17.1] - 2026-09-07
### Changed
No API changes. Corrected `info.version` in `specs/openapi.json`, which was out of sync with this changelog file version to fix an issue that bypassed the automated version-increment CI step.

## [12.17.0] - 2026-08-31
### Added
Added `POST /variable-recurring-payments/commercial/consents/{consentId}/extend` endpoint to avoid automatic revocation of the 13-month-old dormant cVRP consent after receiving a warning via webhook

## [12.16.0] - 2026-08-05
### Changed
Update `PayeeDetails.name` to optional in PaymentResponse
...
## [12.11.0] - 2026-06-26
### Changed
Added multiAuthorisationStatus field to `GET /bulk-payments/{BulkPaymentId}`

## [12.10.2] - 2026-06-09
### Changed
Update `GET /hosted/vrp-requests/commercial/{requestId}` descriptions

## [12.10.1] - 2026-06-08
### Changed
Remove the `applicationId` field in the `POST /hosted/vrp-requests/commercial` request body
...
Delete deprecated Hosted VRP endpoints
...
## [12.3.3] - 2026-04-23
### Changed
Add removed VRP updates during previous OAS file refactor
...
## [12.3.0] - 2026-04-13
### Changed
Update response model description in Bulk Payment Details endpoint

## [12.1.0] - 2026-04-08
### Added
Add new endpoint, Bulk Payment Details `GET /bulk-payments/{bulkPaymentId}/details`, to retrieve details of each payment submitted in a bulk transaction 

## [12.0.0] - 2026-03-03
### Changed
Add Commercial VRP models
Rename Sweeping VRP models for consistency

## [11.5.3] - 2026-02-12
### Changed
Add Commercial VRP features to enum

## [11.5.2] - 2026-01-20
### Changed
Update Data Plus categorised transaction examples (to be in line with new response structure)
...
## [11.4.7] - 2026-01-15
### Changed
Revert string-to-enum changes in Data Plus categorised transaction response structure

## [11.4.6] - 2026-01-13
### Changed
Update Data Plus categorised transaction response structure and descriptions

## [11.4.5] - 2025-12-03
### Changed
Delete Beta tag for sweeping VRP

## [11.4.4] - 2025-10-10
### Changed
Fixing userUuid for sweeping VRP
...
## [11.4.0] - 2025-10-03
### Changed
add beneficiaries API specification
...
## [11.2.1] - 2025-09-04
### Changed
Made `chargeBearer` key Conditional

## [11.2.0] - 2025-08-29
### Changed
Removed sub-application header parameters to endpoint `GET /consents/{consentId}`, `DELETE /consents/{consentId}`, `POST /consents/{consentId}/extend`

## [11.1.0] - 2025-08-14
### Changed
Added sub-application header parameters to endpoint `GET /consents/{consentId}`, `DELETE /consents/{consentId}`, `POST /consents/{consentId}/extend`
